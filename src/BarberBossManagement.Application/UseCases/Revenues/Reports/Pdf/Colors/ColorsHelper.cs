...
namespace BarberBossManagement.Application.UseCases.Revenues.Reports.Pdf.Colors;
public static class ColorsHelper
{
    public static readonly Color RED_DARK = Color.Parse("#DF340C");
    public static readonly Color RED_LIGTH = Color.Parse("#F5C2B6");
    public static readonly Color GREEN_DARK = Color.Parse("#D7E5E5");
    public static readonly Color GREEN_LIGTH = Color.Parse("#F5F9F8");
