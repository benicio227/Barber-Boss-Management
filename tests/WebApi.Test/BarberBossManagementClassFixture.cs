...
public class BarberBossManagementClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public BarberBossManagementClassFixture(CustomWebApplicationFactory customWebApplicationFactory)
    {
